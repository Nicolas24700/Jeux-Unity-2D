...
public bool IsRespawning { get; set; } = false;
        ...
        // playerif (_input.move == Vector2.zero) targetSpeed = 0.0f;
        ...
        private void CameraRotation()
{
    ...
    CinemachineCameraTarget.transform.rotation = Quaternion.Euler(
        ...
        private void Move()
        {
            ...
            // take only the horizontal axe (Q/D)
            ...
            Vector3 moveDirection = new Vector3(horizontalInput, 0.0f, 0.0f).normalized;
            ...
            // lateral and gravity move only in X
